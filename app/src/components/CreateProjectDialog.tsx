...
import { Plus, X, Calendar, FileText, Briefcase, Target, Clock, Rocket, DollarSign } from "lucide-react";
...
export const CreateProjectDialog = ({ open, onOpenChange }: CreateProjectDialogProps) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px] max-h-[90vh] overflow-y-auto border border-gray-200 shadow-xl">
        <DialogHeader className="space-y-3">
          ...
          <DialogDescription className="text-gray-600">
            <p className="text-sm leading-relaxed">
              Set up your new project with a clear title, detailed description, timeline, and budget to get started successfully.
            </p>
                    ...
                    <FormControl>
                      <div className="relative">
                        <Input 
                          ...
                          className={cn(
                            "h-11 border-gray-300 focus:border-blue-500 transition-colors",
                            form.formState.errors.price && "border-red-500 focus:border-red-500"
                          )}
                          {...field}
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <select
                        className={cn(
                          "flex h-11 w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm ring-offset-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors",
                          form.formState.errors.currency && "border-red-500 focus:ring-red-500"
                        )}
                        {...field}
                      >
        ...
        <div className="border-t border-gray-200 pt-4 mt-4">
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-3">
            ...
            <ul className="text-xs text-gray-600 space-y-1 list-disc list-inside">
              ...
              <li>Set realistic timelines and budgets to keep everyone aligned</li>
