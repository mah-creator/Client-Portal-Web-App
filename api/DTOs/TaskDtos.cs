namespace ClientPortalApi.DTOs
{
    ...
    public record TaskResponse(string Id, string ProjectId, string Title, string Description, string Status, DateTime CreatedAt, DateTime UpdatedAt, List<CommentResponse> Comments, DateTime? DueDate=null, string? Assignee=null);
